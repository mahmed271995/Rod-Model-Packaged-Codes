...
1. Forward Code
Contains packaged code for solving the rod model equations using the forward approach, i.e., given a known constitutive law and known boundary conditions, solve for the unknown parameters
